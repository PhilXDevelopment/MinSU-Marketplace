...
export default function LandingPage() {
  ...
  // Don't render the landing page if user is logged in and being redirected
  if (user) {
    return null
  }
            ...
            {[
              {
                title: "Marketplace",
                description:
                  "Buy and sell college essentials, from textbooks to electronics, all within your campus community",
                icon: "🛒",
              ...
              {
                title: "Forum",
                description: "Ask questions, share knowledge, and connect with peers in your field of study",
                icon: "❓",
              ...
              {
                title: "Rewards",
                description: "Earn points and ranks as you contribute to the community and help fellow students",
                icon: "🏆",
            ...
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/marketplace/categories" className="hover:text-white transition-colors">
                      Categories
                    </Link>
                  </li>
                  <li>
                    <Link href="/marketplace/deals" className="hover:text-white transition-colors">
                      Hot Deals
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/forum/topics" className="hover:text-white transition-colors">
                      Popular Topics
                    </Link>
                  </li>
                  <li>
