...
export default function LoginPage() {
  ...
  const validateEmail = (email: string) => {
    setIsEmailValid(email.endsWith("@minsu.edu.ph") || email === "")
    return email.endsWith("@minsu.edu.ph")
  }
  ...
  // Update the handleSubmit function to display different error messages
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!result.success) {
      // Check if it's an account existence error or password error
      if (result.message?.includes("Account does not exist")) {
        toast({
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <Card className="border-gray-200 bg-white shadow-md">
            <CardHeader className="text-center space-y-1 pb-4">
              ...
              <CardDescription className="text-gray-500">Log in to your MinSU account</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 border-gray-200 focus:border-green-500 focus:ring-green-500 ${!isEmailValid ? "border-red-500 focus:ring-red-500" : ""}`}
                      value={email}
